const CACHE="plate-viewer-shell-v4";
const SHELL=["./","./index.html","./styles.css","./enhancements.css","./config.js","./app.js","./editor-enhancement.js","./summary-fix.js","./mobile-controls.js","./vendor/qr-lite.js","./manifest.webmanifest","./icon.svg"];
